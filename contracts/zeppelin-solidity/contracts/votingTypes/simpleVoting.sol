...
// import ".../contracts/VotingType.sol";
// import ".../contracts/governanceData.sol";
// import ".../contracts/ProposalCategory.sol";
// import ".../contracts/memberRoles.sol";
...
contract simpleVoting is VotingType
{
    ...
    {
        return(allVotes[_voteid].voter,allVotes[_voteid].proposalId,allVotes[_voteid].verdictChosen[0],allVotes[_voteid].dateSubmit,allVotes[_voteid].voterTokens);
    }
    ...
    function addVerdictOption(uint _proposalId,uint[] _paramInt,bytes32[] _paramBytes32,address[] _paramAddress)
    {
        ...
        uint roleId = MR.getMemberRoleIdByAddress(msg.sender);
        require(roleId == PC.getRoleSequencAtIndex(_categoryId,index) && AddressProposalVote[msg.sender][_proposalId] == 0 );
    ...
    function finalReward(uint _proposalId) public 
    {
        ...
        for(uint index=0; index<votingLength; index++)
        {
            ...
            for(uint i=0; i<length; i++)
            {
                ...
                require(verdictChosen == finalVerdict);
