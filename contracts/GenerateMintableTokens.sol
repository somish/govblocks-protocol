...
contract GenerateMintableTokens
{
    ...
    function GenerateContract(bytes32 _gbUserName,string _name,address _owner)
    {
       contractAddress[_gbUserName] = new MintableToken(_name,_owner);
    }
