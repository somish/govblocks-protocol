...
contract('Proposal Category', function() {
  ...
  it('Should add a proposal category', async function() {
    ...
    await pc.addNewCategory('Yo', [1], [1], [1], [1],"", address(0), "EX", 0, [0, 0], [0, 0, 0]);
    await catchRevert(pc.addNewCategory('Yo', [1, 2], [1], [1], [1],"", address(0), "EX", 0, [0, 0], [0, 0, 0]));
  ...
  it('Should update a proposal category', async function() {
    ...
    // will throw once owner's permissions are revoked
    await pc.updateCategory(c1, 'YoYo', [1], [1], [1], [1],"", address(0), "EX", 0, [0, 0], [0, 0, 0]);
    await catchRevert(pc.updateCategory(c1, 'YoYo', [1, 1], [1], [1], [1],"", address(0), "EX", 0, [0, 0], [0, 0, 0]));
